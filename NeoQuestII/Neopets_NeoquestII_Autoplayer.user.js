...
(function () {
  ...
  function whoNeedsCure(lowest, word) {
    ...
    for (let td of tds) {
      ...
      if (hpArray) {
        ...
        if (full - current > lowest || current == 0) {
          return [char, current];
        }
      }
    }
  ...
  function getPath(level) {
    const paths = {
      ...
      5: '33333333357111111117111112222262222222268444444444',
      6: '33333333357111111117111111858512222262222222268444444444',
